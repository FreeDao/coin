 ...
 * well.
 */
public class RegActivity extends JQBaseActivity {
	...
	public class UserLoginTask extends AsyncTask<Void, Void, Httpres> {
		...
		@Override
		protected void onPostExecute(final Httpres res) {
			mAuthTask = null;
			showProgress(false);

			if (res.code==0) {
				Toast.makeText(getApplicationContext(), res.message, 1).show();
				Intent it=new Intent();
				it.setClass(RegActivity.this, MainActivity.class);
				startActivity(it);
				finish();
			} else {
				mEmailView
