...
class App(models.Model):
    ...
    apk=models.FileField(upload_to='apk/%m-%Y/',blank=True)
    apkurl=models.CharField(max_length=100,blank=True)
...
class Device(models.Model):
    ...
    spreadnum=models.IntegerField(default=0)
    activenum=models.IntegerField(default=0)
    def __unicode__(self):
        return self.uid
