...
public class E1Activity extends AbsSubActivity{
	private TextView tv;
	private EditText et;
    ...
    private OnClickListener myClickListener = new  OnClickListener(){
		...
		public void onClick(View v) {
			if(v == findViewById(R.id.btn)){
				...
				startActivity(new Intent(E1Activity.this,
						SimpleActivity.class));
			} else if(v == findViewById(R.id.btn4)){
				startActivityForResult(new Intent(E1Activity.this,
